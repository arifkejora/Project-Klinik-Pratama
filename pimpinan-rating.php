...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="pimpinan-rating.php">
  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">Laporan Rating</h5>
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              if ($result->num_rows > 0):
                ...
                <?php endwhile; ?>
              <?php else: ?>
                <tr><td colspan="4" class="text-center">Tidak ada data rating</td></tr>
              <?php endif; ?>
            </tbody>
          </table>

          <a href="generatepdf_rating.php?type=rating" target="_blank" class="btn btn-primary">Cetak PDF Rating</a>
