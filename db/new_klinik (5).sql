...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 20, 2024 at 06:18 AM
...
CREATE TABLE `rating` (
  ...
  `rate_admin` int(5) NOT NULL,
  `rate_dokter` int(5) NOT NULL,
  `rate_farmasi` int(5) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `rating` (`id_rating`, `id_rekam_medis`, `ulasan`, `rate_admin`, `rate_dokter`, `rate_farmasi`) VALUES
(5, 22, 'adsfdgfgfs', 5, 4, 5),
(6, 21, 'qwefr', 4, 4, 4);
...
(22, 11, 'Sakit DB', 'Demam', '130', '67', '34', 'Mencret', '65500', 'Belum Lunas');
