...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT * FROM dokter WHERE email_dokter = '$email' and katasandi_dokter = '$password'";
    ...
    if ($count == 1) {
        $_SESSION['login_doctor'] = $row['nama_dokter'];
        $_SESSION['login_iddoc'] = $row['id_dokter'];
        header("location: doctor-dashboard.php"); // Redirect to admin dashboard
    } else {
