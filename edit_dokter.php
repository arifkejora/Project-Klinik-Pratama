...
if (isset($_GET['id_dokter'])) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "UPDATE dokter SET nip = '$nip', nama_dokter = '$name', email_dokter = '$email', alamat_dokter = '$address', mulai_bekerja = '$startdate' WHERE id_dokter = $id";
            ...
            <div class="card-body">
                ...
                <form class="row g-3" action="" method="POST">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control" id="inputName5" name="name" value="<?php echo $row['nama_dokter']; ?>" required>
                    </div>
                    <div class="col-md-6">
                        <label for="inputEmail5" class="form-label">Email</label>
                        <input type="email" class="form-control" id="inputEmail5" name="email" value="<?php echo $row['email_dokter']; ?>" required>
                    </div>
                    <div class="col-12">
                        <label for="inputAddress5" class="form-label">Alamat Lengkap</label>
                        <input type="text" class="form-control" id="inputAddress5" name="address" value="<?php echo $row['alamat_dokter']; ?>" placeholder="Jl. Kencana" required>
                    </div>
                    <div class="col-md-12">
