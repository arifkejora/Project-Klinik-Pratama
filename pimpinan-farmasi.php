...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="pimpinan-farmasi.php">
  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">Laporan Farmasi</h5>
          <table class="table table-bordered">
            <thead>
              <tr>
                <th scope="col">ID Farmasi</th>
                <th scope="col">NIP</th>
                <th scope="col">Nama Farmasi</th>
            ...
            <tbody>
              <?php
              $sql = "SELECT id_farmasi, nip, nama_farmasi, mulai_bekerja, email_farmasi, alamat_farmasi FROM farmasi";
              $result = $conn->query($sql);
              if ($result->num_rows > 0):
                while ($row = $result->fetch_assoc()): ?>
                  <tr>
                    <td><?php echo $row['id_farmasi']; ?></td>
                    <td><?php echo $row['nip']; ?></td>
                    <td><?php echo $row['nama_farmasi']; ?></td>
                    <td><?php echo $row['mulai_bekerja']; ?></td>
                    <td><?php echo $row['email_farmasi']; ?></td>
                    <td><?php echo $row['alamat_farmasi']; ?></td>
                  </tr>
                <?php endwhile; ?>
              <?php else: ?>
                <tr><td colspan="6" class="text-center">Tidak ada data farmasi</td></tr>
              <?php endif; ?>
            </tbody>
          </table>
          <a href="generatepdf_farmasi.php?type=farmasi" target="_blank" class="btn btn-primary">Cetak PDF Farmasi</a>
