...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link " href="pimpinan-obat.php">
  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">Rekap Obat</h5>
          <table class="table table-bordered">
            ...
            <tbody>
              <?php
              $sql = "SELECT id_obat, nama_obat, jenis_obat, harga_obat FROM obat";
          ...
          <a href="generatepdf_obat.php?type=obat" target="_blank" class="btn btn-primary">Cetak PDF Obat</a>
        </div>
      </div>
    </div>
  </div>
