...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $resep_obat = explode(',', $_POST['resep_obat_ids']); // Use the hidden input field for ids

    // Insert into rekam_medis
    $rekamMedisQuery = "
        INSERT INTO rekam_medis (id_antrian, keluhan, diagnosa, tekanan_darah, berat_badan, suhu_badan, hasil_pemeriksaan) 
        VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    $resepObatQuery = "
        INSERT INTO resep_obat (id_rekammedis, id_obat) 
        VALUES (?, ?)";
    ...
    // Redirect back to the doctor dashboard or another appropriate page
