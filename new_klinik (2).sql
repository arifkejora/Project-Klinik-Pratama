...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 22, 2024 at 04:31 PM
...
(2, 1, 'Laki-laki', '2024-06-20', 'Jalan Kencana', '36', '3604', '3604130', '3604130010');
...
INSERT INTO `rujukan` (`id_rujukan`, `id_rekammedis`, `nama_rumahsakit`, `nama_dokter`, `poli`, `tanggal_rujukan`) VALUES
(2, 12, 'RS Kumala Siwi', 'Paiman, S.Tr', 'Poli Gigi', '2024-06-23');
...
--
ALTER TABLE `detail_pasien`
  MODIFY `id_detail_pasien` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
